...
// Purchase-side mirror of PostedSalesCrMemoSubform.PageExt.al.
// The "Applied to" fields link each purchase credit memo line to the original purchase invoice line it offsets,
...
pageextension 51107 "Posted Purch. Cr. Memo Subform" extends "Posted Purch. Cr. Memo Subform"
{
    layout
    {
        addafter("Total Amount Incl. VAT")
        {
            ...
            // Purchase credit memo entries carry negative amounts by convention (Spike 5.3.1 decision: amounts stored as-is).
